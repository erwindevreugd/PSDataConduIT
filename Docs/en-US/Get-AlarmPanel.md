...
### -PanelID
Specifies the panel id of the alarm panel(s) to get.
...
### -AlarmPanelID
Specifies the alarm panel id of the alarm panel(s) to get.
...
### -Name
Specifies the name of the alarm panel to get.
